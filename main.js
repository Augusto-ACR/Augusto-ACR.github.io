...
const translations = {
    es: {
        ...
        cta_available: "Disponible full-time · Remoto o híbrido · Neuquén / Río Negro, Argentina",
        education_title: "Formación",
        edu1_title: "Técnico Desarrollador Full Stack",
        edu1_status: "En curso",
        edu2_title: "Técnico Electrónico en Automatización y Control de Procesos",
        edu2_status: "Completado",
        certs_title: "Certificaciones",
        cert_english: "Inglés B2 — First Certificate",
        cert_back: "Programación BackEnd",
        cert_front: "Programación FrontEnd",
        cert_int: "Integración de Aplicaciones",
        cert_ux: "Diseño UX/UI",
        ...
        rol_cuentitas: "Proyecto personal · Repo privado — código disponible en entrevista",
        rol_rimainder: "Proyecto personal",
        rol_sggm: "Co-desarrollador — proyecto en equipo",
        rol_argencash: "Co-desarrollador — proyecto en equipo",
        argencash_desc: "App móvil para consultar en tiempo real las cotizaciones del dólar en Argentina (oficial, blue, MEP y más) y convertir montos entre pesos y cada tipo de cambio. Incluye pantallas de detalle por cotización, calculadora de conversión y manejo de estados de carga y error.",
        argencash_tech: "Tecnologías: React Native, Expo, TypeScript, Expo Router y consumo de API pública (DolarAPI).",
    ...
    en: {
        ...
        cta_available: "Available full-time · Remote or hybrid · Neuquén / Río Negro, Argentina",
        education_title: "Education",
        edu1_title: "Full Stack Developer Technical Degree",
        edu1_status: "In progress",
        edu2_title: "Electronics Technician — Automation & Process Control",
        edu2_status: "Completed",
        certs_title: "Certifications",
        cert_english: "English B2 — First Certificate",
        cert_back: "Back-End Programming",
        cert_front: "Front-End Programming",
        cert_int: "Application Integration",
        cert_ux: "UX/UI Design",
        ...
        rol_cuentitas: "Personal project · Private repo — code available on interview",
        rol_rimainder: "Personal project",
        rol_sggm: "Co-developer — team project",
        rol_argencash: "Co-developer — team project",
        argencash_desc: "Mobile app to check Argentina's dollar exchange rates in real time (official, blue, MEP and more) and convert amounts between pesos and each rate. It includes detail screens per quote, a conversion calculator and loading/error state handling.",
        argencash_tech: "Technologies: React Native, Expo, TypeScript, Expo Router and public API consumption (DolarAPI).",
        link_code: "View code",
